 ...
 */
export async function compendium_lookup_lid_plural(lid: string, short_circuit: boolean=true, types?: EntryType | EntryType[]): Promise<Array<LancerActor | LancerItem>>{
...
export async function compendium_lookup_lid(lid: string, types?: EntryType | EntryType[]): Promise<LancerActor | LancerItem | null> {
