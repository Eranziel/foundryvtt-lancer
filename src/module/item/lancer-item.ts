 ...
 */
const weapon_range_preview = `{{#if range.val}}
 ...
 */
const weapon_damage_preview = `{{#if damage.type}}
 ...
 */
const npc_attack_bonus_preview = `<div class="compact-acc">
 ...
 */
const npc_accuracy_preview = `{{#if (gtpi acc "0")}}
 ...
 */
const mech_weapon_preview = `<div class="flexcol clipped lancer-weapon-container weapon" style="max-height: fit-content;" data-item-id="{{key}}">
 ...
 */
const mech_trait_preview = `<div class="lancer-mech-trait-header medium clipped-top" style="grid-area: 1/1/2/2">
 ...
 */
const core_system_preview = `<div class="card clipped frame-core flexcol">
